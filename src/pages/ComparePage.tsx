...
export function ComparePage() {
  ...
  return (
    <Container className="py-10">
      ...
      {/* Estado vacío: selección de familia + CTA al futuro asistente */}
      {compare.length === 0 && (
        <div className="mt-6 rounded-[16px] border border-line bg-neutral p-6">
          ...
          <p className="mt-3 text-sm text-muted">
            El comparador acepta hasta tres modelos del mismo tipo. Ajusta la selección abajo o
            deja que el asistente te oriente.
          </p>
          <div className="mt-4">
            <button
              type="button"
