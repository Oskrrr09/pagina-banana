...
const MODEL_META: Record<string, ModelDecisionMeta> = {
  ...
  // -------------------- Mac --------------------
  // Datos alineados con las páginas oficiales de Apple (apple.com/es/shop/mac/…).
  // Estos slugs son los usados en products.ts. Se etiquetan como demostrativos
  // pero coinciden con la comunicación pública de Apple a fecha 2026-07.
  'macbook-neo': {
    usoRecomendado: 'Portátil ligero para estudio y ofimática.',
    strengths: ['Precio de entrada', 'Chip Apple Silicon', 'Peso contenido'],
    portabilityLevel: 3,
    performanceLevel: 1,
    batteryLevel: 2,
    valueLevel: 3,
    ...
    fields: {
      Chip: 'Apple Silicon (M-series entrada)',
      'CPU / GPU': '8 núcleos CPU · 8 núcleos GPU',
      'Memoria unificada': '8 o 16 GB',
      'Almacenamiento inicial': '256 GB · hasta 512 GB',
      Pantalla: 'Retina 13" · True Tone',
      Autonomía: 'Hasta 18 h reproducción',
      Peso: 'Aprox. 1,2 kg',
      Puertos: '2 × Thunderbolt / USB-C',
      Cámara: 'FaceTime HD 720p',
      'Uso recomendado': 'Estudio, ofimática y navegación diaria.',
    },
  },
  'macbook-air-m4': {
    usoRecomendado: 'Portátil ultrafino con M4 para uso diario y móvil.',
    strengths: ['Muy ligero', 'M4 eficiente', 'Autonomía alta'],
    portabilityLevel: 3,
    performanceLevel: 2,
    batteryLevel: 3,
    valueLevel: 2,
    ...
    fields: {
      Chip: 'Apple M4',
      'CPU / GPU': '10 núcleos CPU · hasta 10 núcleos GPU',
      'Memoria unificada': 'Desde 16 GB · hasta 32 GB',
      'Almacenamiento inicial': '256 GB · hasta 2 TB',
      Pantalla: 'Liquid Retina 13,6" o 15,3" · 500 nits',
      Autonomía: 'Hasta 18 h reproducción',
      Peso: '1,24 kg (13") · 1,51 kg (15")',
      Puertos: 'MagSafe 3 + 2 × Thunderbolt / USB 4',
      Cámara: '12 MP Center Stage',
      'Uso recomendado': 'Trabajo móvil, estudio y viajes.',
    },
  },
  'macbook-air-m5': {
    usoRecomendado: 'MacBook Air con M5 y Apple Intelligence.',
    strengths: ['M5 eficiente', 'Diseño sin ventilador', 'Autonomía alta'],
    portabilityLevel: 3,
    performanceLevel: 2,
    batteryLevel: 3,
    valueLevel: 2,
    ...
    fields: {
      ...
      'Memoria unificada': '16 o 24 GB',
      'Almacenamiento inicial': '512 GB · hasta 2 TB',
      Pantalla: 'Liquid Retina 13,6" o 15,3" · 500 nits',
      Autonomía: 'Hasta 18 h reproducción',
      Peso: '1,24 kg (13") · 1,51 kg (15")',
      Puertos: 'MagSafe 3 + 2 × Thunderbolt / USB 4',
      Cámara: '12 MP Center Stage',
      'Uso recomendado': 'Trabajo móvil con margen para Apple Intelligence.',
    },
  },
  'macbook-pro-m4': {
    usoRecomendado: 'Rendimiento profesional M4 con pantalla XDR.',
    strengths: ['M4 potente', 'Pantalla Liquid Retina XDR', 'Batería muy larga'],
    portabilityLevel: 2,
    performanceLevel: 3,
    batteryLevel: 3,
    valueLevel: 1,
    ...
    fields: {
      ...
      'CPU / GPU': 'Hasta 16 núcleos CPU · 40 núcleos GPU',
      'Memoria unificada': 'Desde 16 GB · hasta 128 GB',
      'Almacenamiento inicial': '512 GB · hasta 8 TB',
      Pantalla: 'Liquid Retina XDR 14,2" o 16,2" · mini-LED · 1600 nits HDR',
      Autonomía: 'Hasta 24 h reproducción',
      Peso: '1,55 kg (14") · 2,14 kg (16")',
      Puertos: 'MagSafe 3 · 3 × Thunderbolt 4/5 · HDMI · SDXC',
      Cámara: '12 MP Center Stage',
      'Uso recomendado': 'Vídeo, código, 3D y trabajo profesional.',
    },
  },
  'macbook-pro-m5': {
    usoRecomendado: 'Máxima potencia portátil con la última generación M5.',
    strengths: ['M5 Pro/Max potente', 'Pantalla Liquid Retina XDR', 'Batería muy larga'],
    portabilityLevel: 2,
    performanceLevel: 3,
    batteryLevel: 3,
    valueLevel: 1,
    ...
    macFormFactor: 'portable',
    fields: {
      Chip: 'Apple M5 · M5 Pro · M5 Max',
      'CPU / GPU': 'Hasta 16 núcleos CPU · 40 núcleos GPU',
      'Memoria unificada': 'Desde 16 GB · hasta 128 GB',
      'Almacenamiento inicial': '1 TB · hasta 8 TB',
      Pantalla: 'Liquid Retina XDR 14,2" o 16,2" · mini-LED · 1600 nits HDR',
      Autonomía: 'Hasta 24 h reproducción',
      Peso: '1,55 kg (14") · 2,14 kg (16")',
      Puertos: 'MagSafe 3 · 3 × Thunderbolt 5 · HDMI · SDXC',
      Cámara: '12 MP Center Stage',
      'Uso recomendado': 'Vídeo 8K, código pesado, 3D y ciencia de datos.',
    },
  },
  'imac-24-m4': {
    usoRecomendado: 'Todo en uno con pantalla Retina 4,5K integrada.',
    strengths: ['Todo en uno', 'Pantalla 4,5K integrada', 'Diseño delgado y de colores'],
    portabilityLevel: 1,
    performanceLevel: 2,
    valueLevel: 2,
    professionalLevel: 2,
    ...
    fields: {
      Chip: 'Apple M4',
      'CPU / GPU': '8 o 10 núcleos CPU · 8 o 10 núcleos GPU',
      'Memoria unificada': 'Desde 16 GB · hasta 32 GB',
      'Almacenamiento inicial': '256 GB · hasta 2 TB',
      Pantalla: 'Retina 4,5K 24" · 4480 × 2520 · 500 nits',
      Autonomía: 'Sobremesa · alimentación por cable',
      Peso: 'Aprox. 4,4 kg',
      Puertos: '2 o 4 × Thunderbolt / USB 4',
      Cámara: '12 MP Center Stage',
      'Uso recomendado': 'Escritorio en casa u oficina, familia y creatividad.',
    },
  },
  'mac-mini-m4': {
    usoRecomendado: 'Mac compacto de sobremesa, ampliable con tu monitor.',
    strengths: ['Muy compacto', 'Excelente relación calidad-precio', 'M4 o M4 Pro'],
    portabilityLevel: 1,
    performanceLevel: 2,
    valueLevel: 3,
    professionalLevel: 2,
    ...
    fields: {
      ...
      'Memoria unificada': 'Desde 16 GB · hasta 64 GB',
      'Almacenamiento inicial': '256 GB · hasta 8 TB',
      Pantalla: 'Sin pantalla integrada',
      Autonomía: 'Sobremesa · alimentación por cable',
      Peso: 'Aprox. 0,67 kg',
      Puertos: '3 × Thunderbolt · HDMI · 2 × USB-C · Ethernet',
      Cámara: 'No incluida',
      'Uso recomendado': 'Setup de escritorio ampliable con monitor propio.',
    },
  },
  'mac-studio': {
    usoRecomendado: 'Estudio profesional exigente con máxima potencia.',
    strengths: ['Máxima potencia', 'M4 Max / M3 Ultra', 'Conectividad profesional'],
    portabilityLevel: 1,
    performanceLevel: 3,
    valueLevel: 1,
    professionalLevel: 3,
    ...
    fields: {
      ...
      'Memoria unificada': 'Desde 36 GB · hasta 192 GB (M3 Ultra: 512 GB)',
      'Almacenamiento inicial': '512 GB · hasta 16 TB',
      Pantalla: 'Sin pantalla integrada',
      Autonomía: 'Sobremesa · alimentación por cable',
      Peso: 'Aprox. 2,7 kg',
      Puertos: '4 × Thunderbolt 5 · 2 × USB-A · HDMI · Ethernet 10 Gb',
      Cámara: 'No incluida',
      'Uso recomendado': 'Producción de vídeo, 3D, ML y estudios profesionales.',
    },
  },
  // -------------------- iPad --------------------
  // Datos alineados con apple.com/es/shop/ipad/… — 2026-07.
  'ipad-pro': {
    usoRecomendado: 'Trabajo creativo, dibujo avanzado y edición pro.',
    strengths: ['Pantalla Ultra Retina XDR OLED', 'Chip M5', 'Apple Pencil Pro'],
    portabilityLevel: 3,
    performanceLevel: 3,
    batteryLevel: 2,
    valueLevel: 1,
    ...
    fields: {
      Pantalla: 'Ultra Retina XDR OLED · 11" o 13" · ProMotion 120 Hz · 1000 nits (1600 HDR)',
      Chip: 'Apple M5',
      ...
      'Almacenamiento inicial': '256 GB · hasta 2 TB',
      Peso: '444 g (11") · 579 g (13")',
      Autonomía: 'Hasta 10 h con Wi-Fi',
      'Uso recomendado': 'Ilustración pro, edición de vídeo y flujo profesional.',
    },
  },
  'ipad-air': {
    usoRecomendado: 'Estudio, dibujo y edición ligera con muy buena relación calidad-precio.',
    strengths: ['M4 en formato Air', 'Apple Pencil Pro', 'Dos tamaños'],
    portabilityLevel: 3,
    performanceLevel: 2,
    batteryLevel: 2,
    valueLevel: 2,
    ...
    supportsKeyboard: true,
    fields: {
      Pantalla: 'Liquid Retina · 11" o 13" · 500 nits · True Tone',
      Chip: 'Apple M4',
      'Apple Pencil': 'Apple Pencil Pro · Apple Pencil (USB-C)',
      'Teclado compatible': 'Magic Keyboard para iPad Air',
      'Cámara trasera': '12 MP gran angular',
      'Almacenamiento inicial': '128 GB · hasta 1 TB',
      Peso: '460 g (11") · 617 g (13")',
      Autonomía: 'Hasta 10 h con Wi-Fi',
      'Uso recomendado': 'Estudio, apuntes y creatividad diaria.',
    },
  },
  'ipad-mini': {
    usoRecomendado: 'Portabilidad extrema, lectura y viajes.',
    strengths: ['Muy compacto', 'A17 Pro', 'Apple Pencil Pro'],
    portabilityLevel: 3,
    performanceLevel: 2,
    batteryLevel: 2,
    valueLevel: 2,
    ...
    fields: {
      Pantalla: 'Liquid Retina 8,3" · 500 nits · True Tone',
      Chip: 'Apple A17 Pro',
      'Apple Pencil': 'Apple Pencil Pro · Apple Pencil (USB-C)',
      'Teclado compatible': 'Sin Magic Keyboard oficial',
      'Cámara trasera': '12 MP gran angular',
      'Almacenamiento inicial': '128 GB · hasta 512 GB',
      Peso: '293 g (Wi-Fi)',
      Autonomía: 'Hasta 10 h con Wi-Fi',
      'Uso recomendado': 'Lectura, notas rápidas y consumo multimedia móvil.',
    },
  },
  'ipad-a16': {
    usoRecomendado: 'iPad para el día a día con muy buen precio de entrada.',
    strengths: ['Precio ajustado', 'Chip A16', 'Cuatro colores'],
    portabilityLevel: 2,
    performanceLevel: 2,
    batteryLevel: 2,
    valueLevel: 3,
    ...
    supportsKeyboard: true,
    fields: {
      Pantalla: 'Liquid Retina 11" · 500 nits · True Tone',
      Chip: 'Apple A16',
      'Apple Pencil': 'Apple Pencil (USB-C) · Apple Pencil (1.ª gen.)',
      'Teclado compatible': 'Magic Keyboard Folio',
      'Cámara trasera': '12 MP gran angular',
      'Almacenamiento inicial': '128 GB · hasta 512 GB',
      Peso: '477 g (Wi-Fi)',
      Autonomía: 'Hasta 10 h con Wi-Fi',
      'Uso recomendado': 'Uso diario, familia, estudio básico.',
    },
  },

  // -------------------- Apple Watch --------------------
  // Datos alineados con apple.com/es/shop/watch/… — 2026-07.
  'watch-ultra-3': {
    usoRecomendado: 'Deporte extremo, buceo y aventura con máxima autonomía.',
    strengths: ['42 h de autonomía', 'Titanio WR100', 'Mensajes vía satélite'],
    portabilityLevel: 3,
    performanceLevel: 3,
    batteryLevel: 3,
    valueLevel: 1,
    ...
    fields: {
      ...
      Materiales: 'Titanio (natural o negro)',
      Autonomía: 'Hasta 42 h · hasta 72 h en bajo consumo',
      Conectividad: 'GPS de doble frecuencia · Cellular · Satélite',
      'Sensores principales': 'ECG · SpO2 · temperatura · profundidad · frec. cardiaca',
      Resistencia: 'WR100 · IP6X · EN13319 · MIL-STD-810H',
      Chip: 'Apple S11 SiP',
      Peso: 'Aprox. 61,4 g',
      'Uso recomendado': 'Submarinismo, trail running, montaña y aventura.',
    },
  },
  'watch-series-11': {
    usoRecomendado: 'Salud, deporte y uso cotidiano completo.',
    strengths: ['ECG y oxígeno en sangre', 'Detección de apnea del sueño', 'Pantalla siempre activa'],
    portabilityLevel: 3,
    performanceLevel: 3,
    batteryLevel: 2,
    valueLevel: 2,
    ...
    fields: {
      ...
      Autonomía: 'Hasta 24 h · hasta 36 h en bajo consumo',
      Conectividad: 'GPS · opción GPS + Cellular',
      'Sensores principales': 'ECG · SpO2 · temperatura · apnea del sueño · frec. cardiaca',
      Resistencia: 'WR50 · IP6X',
      Chip: 'Apple S11 SiP',
      Peso: 'Aluminio 42 mm ~29 g · 46 mm ~35 g',
      'Uso recomendado': 'Salud y deporte diario con notificaciones y salud avanzada.',
    },
  },
  'watch-se-3': {
    usoRecomendado: 'Iniciación al Apple Watch a mejor precio.',
    strengths: ['Precio de entrada', 'Detección de caídas', 'Chip S10'],
    portabilityLevel: 3,
    performanceLevel: 2,
    batteryLevel: 2,
    valueLevel: 3,
    ...
    fields: {
      ...
      Materiales: 'Aluminio (medianoche o blanco estrella)',
      Autonomía: 'Hasta 18 h',
      Conectividad: 'GPS · opción GPS + Cellular',
      'Sensores principales': 'Frec. cardiaca · caídas · choques · sueño',
      Resistencia: 'WR50',
      Chip: 'Apple S10 SiP',
      Peso: 'Aluminio 40 mm ~26 g · 44 mm ~33 g',
      'Uso recomendado': 'Primer Apple Watch, uso familiar y actividad diaria.',
    },
  },
...
const MAC_DESKTOP_SLUGS = new Set(['imac-24-m4', 'mac-mini-m4', 'mac-studio'])
