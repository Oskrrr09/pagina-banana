...
export const macModels: Model[] = [
  {
    ...
    colors: buildColors([
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-neo-plata.png`, caps: [['8 GB · 256 GB', 749], ['8 GB · 512 GB', 999]] },
      { slug: 'citrico', name: 'Cítrico', hex: '#d0c875', image: `${IMG}/macbook-neo-citrico.png`, caps: [['8 GB · 256 GB', 749], ['8 GB · 512 GB', 999]] },
      { slug: 'rosa-nube', name: 'Rosa nube', hex: '#e8bfc4', image: `${IMG}/macbook-neo-rosa-nube.png`, caps: [['8 GB · 256 GB', 749], ['8 GB · 512 GB', 999]] },
      { slug: 'indigo', name: 'Índigo', hex: '#6b7ab8', image: `${IMG}/macbook-neo-indigo.png`, caps: [['8 GB · 256 GB', 749], ['8 GB · 512 GB', 999]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'medianoche', name: 'Medianoche', hex: '#2c3138', image: `${IMG}/macbook-air-medianoche.png`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['13" · 16 GB · 512 GB', 1369], ['15" · 16 GB · 256 GB', 1299, 1379], ['15" · 16 GB · 512 GB', 1549]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-air-plata.png`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['13" · 16 GB · 512 GB', 1369], ['15" · 16 GB · 256 GB', 1299, 1379], ['15" · 16 GB · 512 GB', 1549]] },
      { slug: 'blanco-estrella', name: 'Blanco estrella', hex: '#ded8ca', image: `${IMG}/macbook-air-blanco-estrella.png`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['13" · 16 GB · 512 GB', 1369], ['15" · 16 GB · 256 GB', 1299, 1379], ['15" · 16 GB · 512 GB', 1549]] },
      { slug: 'azul-cielo', name: 'Azul cielo', hex: '#a9c3d6', image: `${IMG}/macbook-air-skyblue.png`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['13" · 16 GB · 512 GB', 1369], ['15" · 16 GB · 256 GB', 1299, 1379], ['15" · 16 GB · 512 GB', 1549]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'negro', name: 'Negro espacial', hex: '#2a2a2c', image: `${IMG}/mac-mbp14-negro.png`, caps: [['14" · 16 GB · 512 GB', 1699, 1899], ['16" · 24 GB · 512 GB', 2699]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/mac-mbp14-plata.png`, caps: [['14" · 16 GB · 512 GB', 1699, 1899], ['16" · 24 GB · 512 GB', 2699]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'azul-cielo', name: 'Azul cielo', hex: '#a9c3d6', image: `${IMG}/macbook-air-skyblue.png`, caps: [['13" · 16 GB · 512 GB', 1319], ['13" · 24 GB · 512 GB', 1579], ['15" · 16 GB · 512 GB', 1579, 1649], ['15" · 24 GB · 512 GB', 1849]] },
      { slug: 'medianoche', name: 'Medianoche', hex: '#2c3138', image: `${IMG}/macbook-air-medianoche.png`, caps: [['13" · 16 GB · 512 GB', 1319], ['13" · 24 GB · 512 GB', 1579], ['15" · 16 GB · 512 GB', 1579, 1649], ['15" · 24 GB · 512 GB', 1849]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-air-plata.png`, caps: [['13" · 16 GB · 512 GB', 1319], ['13" · 24 GB · 512 GB', 1579], ['15" · 16 GB · 512 GB', 1579, 1649], ['15" · 24 GB · 512 GB', 1849]] },
      { slug: 'blanco-estrella', name: 'Blanco estrella', hex: '#ded8ca', image: `${IMG}/macbook-air-blanco-estrella.png`, caps: [['13" · 16 GB · 512 GB', 1319], ['13" · 24 GB · 512 GB', 1579], ['15" · 16 GB · 512 GB', 1579, 1649], ['15" · 24 GB · 512 GB', 1849]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'negro', name: 'Negro espacial', hex: '#2a2a2c', image: `${IMG}/macbook-pro-m5-negro-16.png`, caps: [['14" · 16 GB · 1 TB', 1839, 2119], ['16" · 24 GB · 1 TB', 2999]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-pro-m5-plata-14.png`, caps: [['14" · 16 GB · 1 TB', 1839, 2119], ['16" · 24 GB · 1 TB', 2999]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/mac-studio-photo.png`, caps: [['M4 Max · 36 GB · 512 GB', 2499], ['M3 Ultra · 96 GB · 1 TB', 4999, null, 'bajo-pedido', 'Recíbelo en 5-7 días']] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/mac-mini-m4-photo.png`, caps: [['16 GB · 256 GB', 719], ['16 GB · 512 GB', 949], ['M4 Pro · 24 GB · 512 GB', 1649]] },
    ]),
