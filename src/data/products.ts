...
export const macModels: Model[] = [
  {
    ...
    colors: buildColors([
      { slug: 'citrico', name: 'Cítrico', hex: '#d8d19a', image: `${IMG}/macbook-neo-photo.jpg`, caps: [['8 GB · 256 GB', 729, 759], ['16 GB · 512 GB', 999]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-neo-photo.jpg`, caps: [['8 GB · 256 GB', 729, 759], ['16 GB · 512 GB', 999]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'medianoche', name: 'Medianoche', hex: '#2c3138', image: `${IMG}/macbook-air-m4-photo.jpg`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['15" · 16 GB · 256 GB', 1299]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-air-m4-photo.jpg`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['15" · 16 GB · 256 GB', 1299]] },
      { slug: 'blanco-estrella', name: 'Blanco estrella', hex: '#ded8ca', image: `${IMG}/macbook-air-m4-photo.jpg`, caps: [['13" · 16 GB · 256 GB', 1119, 1199], ['15" · 16 GB · 256 GB', 1299]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'negro', name: 'Negro espacial', hex: '#2a2a2c', image: `${IMG}/macbook-pro-m4-photo.jpg`, caps: [['14" · 16 GB · 512 GB', 1699, 1899], ['16" · 24 GB · 512 GB', 2699]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-pro-m4-photo.jpg`, caps: [['14" · 16 GB · 512 GB', 1699, 1899], ['16" · 24 GB · 512 GB', 2699]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'azul-cielo', name: 'Azul cielo', hex: '#a9c3d6', image: `${IMG}/macbook-air-m5-photo.jpg`, caps: [['13" · 16 GB · 512 GB', 1319], ['15" · 16 GB · 512 GB', 1579, 1649]] },
      { slug: 'medianoche', name: 'Medianoche', hex: '#2c3138', image: `${IMG}/macbook-air-m5-photo.jpg`, caps: [['13" · 16 GB · 512 GB', 1319], ['15" · 16 GB · 512 GB', 1579, 1649]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-air-m5-photo.jpg`, caps: [['13" · 16 GB · 512 GB', 1319], ['15" · 16 GB · 512 GB', 1579, 1649]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'negro', name: 'Negro espacial', hex: '#2a2a2c', image: `${IMG}/macbook-pro-m5-photo.jpg`, caps: [['14" · 16 GB · 1 TB', 1839, 2119], ['16" · 24 GB · 1 TB', 2999]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/macbook-pro-m5-photo.jpg`, caps: [['14" · 16 GB · 1 TB', 1839, 2119], ['16" · 24 GB · 1 TB', 2999]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'azul', name: 'Azul', hex: '#9ab9ca', image: `${IMG}/imac-24-m4-photo.jpg`, caps: [['16 GB · 256 GB', 1499], ['16 GB · 512 GB', 1749]] },
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/imac-24-m4-photo.jpg`, caps: [['16 GB · 256 GB', 1499], ['16 GB · 512 GB', 1749]] },
      { slug: 'rosa', name: 'Rosa', hex: '#d9a6a2', image: `${IMG}/imac-24-m4-photo.jpg`, caps: [['16 GB · 256 GB', 1499], ['16 GB · 512 GB', 1749]] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/mac-studio-photo.jpg`, caps: [['M4 Max · 36 GB · 512 GB', 2499], ['M3 Ultra · 96 GB · 1 TB', 4999, null, 'bajo-pedido', 'Recíbelo en 5-7 días']] },
    ]),
  ...
  },
  {
    ...
    colors: buildColors([
      { slug: 'plata', name: 'Plata', hex: '#d8d9dc', image: `${IMG}/mac-mini-m4-photo.jpg`, caps: [['16 GB · 256 GB', 719], ['16 GB · 512 GB', 949], ['M4 Pro · 24 GB · 512 GB', 1649]] },
    ]),
