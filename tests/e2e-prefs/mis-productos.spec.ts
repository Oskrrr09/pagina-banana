...
// ============================================================================
// La pantalla `/mis-productos`, que se llama «Mis productos» desde la PR #57.
//
...
test('sin compras explica para qué sirve la pantalla', async ({ page }) => {
  ...
  await expect(page.getByText(/Los accesorios y el detalle de cada compra están en Mis pedidos/)).toBeVisible()
